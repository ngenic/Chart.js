...
type FillTarget = number | string | 'start' | 'end' | 'origin' | false;
...
interface ICartesianScaleOptions extends IScaleOptions {
  /**
...
type ILinearScaleOptions = IScaleOptions & {
  stacked?: boolean;
...
type IRadialLinearScaleOptions = IScaleOptions & {
  animate: boolean;
...
interface ILinearScaleType extends DeepPartial<ILinearScaleOptions> {
  type: 'linear';
}
interface ILogarithmicScaleType extends DeepPartial<ILogarithmicScaleOptions> {
  type: 'logarithmic';
}
interface ICategoryScaleType extends DeepPartial<ICategoryScaleOptions> {
  type: 'category';
}
interface IRadialLinearScaleType extends DeepPartial<IRadialLinearScaleOptions> {
  type: 'radialLinear';
}
interface ITimeScaleType extends DeepPartial<ITimeScaleOptions> {
  type: 'time';
}
interface ITimeSeriesScaleType extends DeepPartial<ITimeScaleOptions> {
  type: 'timeseries';
}

interface IScaleChartOptions {
  scales: {
...
type IChartDataset<T = number, O = {}> = DeepPartial<IControllerDatasetOptions & IParsingOptions & O> & {
  data: T[];
};

type IBarControllerDataset<T = number> = IChartDataset<T, IBarControllerDatasetOptions>;
type ILineControllerDataset<T = IScatterDataPoint> = IChartDataset<
  T,
  ILineControllerDatasetOptions & IFillerControllerDatasetOptions
>;
type IScatterControllerDataset<T = IScatterDataPoint> = IChartDataset<T, IScatterControllerDatasetOptions>;
type IBubbleControllerDataset<T = IBubbleDataPoint> = IChartDataset<T, IBubbleControllerDatasetOptions>;
type IPieControllerDataset<T = IPieDataPoint> = IChartDataset<T, IPieControllerDatasetOptions>;
type IDoughnutControllerDataset<T = IDoughnutDataPoint> = IChartDataset<T, IDoughnutControllerDatasetOptions>;
type IPolarAreaControllerDataset<T = number> = IChartDataset<T, IPolarAreaControllerDatasetOptions>;
type IRadarControllerDataset<T = number> = IChartDataset<T, IRadarControllerDatasetOptions>;

interface IChartData<T = number, L = string, DS extends IChartDataset<T> = IChartDataset<T>>
  extends DeepPartial<IParsingOptions> {
  labels: L[];
  datasets: DS[];
}

type IChartOptions<O = {}> = DeepPartial<
  ICoreChartOptions &
...
type IBarControllerConfiguration<T = number, L = string> = IChartConfiguration<
  'bar',
  T,
  L,
...
>;
type ILineControllerConfiguration<T = IScatterDataPoint, L = string> = IChartConfiguration<
  'line',
  T,
  L,
...
>;
type IScatterControllerConfiguration<T = IScatterDataPoint, L = string> = IChartConfiguration<
  'scatter',
  T,
  L,
...
>;
type IBubbleControllerConfiguration<T = IBubbleDataPoint, L = string> = IChartConfiguration<
  'bubble',
  T,
  L,
  IBubbleControllerDataset<T>
>;
type IPieControllerConfiguration<T = IPieDataPoint, L = string> = IChartConfiguration<
  'pie',
  T,
  L,
...
>;
type IDoughnutControllerConfiguration<T = IDoughnutDataPoint, L = string> = IChartConfiguration<
  'doughnut',
  T,
  L,
...
>;
type IPolarAreaControllerConfiguration<T = number, L = string> = IChartConfiguration<
  'polarArea',
  T,
  L,
...
>;
type IRadarControllerConfiguration<T = number, L = string> = IChartConfiguration<
  'radar',
  T,
  L,
...
type ConfigurationOptions<O> = O extends IChartConfiguration<unknown, unknown, unknown, infer O> ? O : never;
type ConfigurationData<O> = O extends IChartConfiguration<unknown, infer T, infer L, infer DS, unknown>
  ? IChartData<T, L, DS>
  : never;
type ConfigurationDataset<O> = O extends IChartConfiguration<unknown, unknown, unknown, infer DS, unknown>
  ? DS
  : never;
...
type UpdateMode = 'resize' | 'reset' | 'none' | 'hide' | 'show' | 'normal' | 'active' | undefined;
...
interface Scale<O extends IScaleOptions = IScaleOptions> extends Element<{}, O>, IChartArea {
  readonly id: string;
...
interface IScatterControllerChartOptions extends ILineControllerChartOptions {
  scales: {
    x: ILinearScaleType;
    y: ILinearScaleType;
  };
...
export { IInteractionOptions as $, Animation as A, BarController as B, IAnimationEvent as C, DoughnutController as D, Animator as E, Animations as F, IAnimationCommonSpec as G, IAnimationPropertySpec as H, IControllerDatasetOptions as I, IAnimationSpecContainer as J, IAnimationOptions as K, LineController as L, IChartAnimationOptions as M, IChartMeta as N, IParsingOptions as O, PieController as P, Chart as Q, RadarController as R, ScatterController as S, ChartItem as T, UpdateMode as U, DatasetController as V, IDatasetControllerChartComponent as W, Defaults as X, defaults as Y, Element as Z, _adapters as _, IBarControllerDatasetOptions as a, DomPlatform as a$, InteractionItem as a0, InteractionModeFunction as a1, IInteractionMode as a2, InteractionMode as a3, Interaction as a4, LayoutPosition as a5, ILayoutItem as a6, layouts as a7, PluginService as a8, IPlugin as a9, IPointPrefixedHoverOptions as aA, Point as aB, IRectangleProps as aC, IRectangleOptions as aD, IRectangleHoverOptions as aE, Rectangle as aF, IElementChartOptions as aG, Color as aH, IEvent as aI, IPoint as aJ, IChartComponent as aK, TimeUnit as aL, IChartArea as aM, IPadding as aN, IScriptableContext as aO, Scriptable as aP, ScriptableOptions as aQ, ScriptableAndArray as aR, ScriptableAndArrayOptions as aS, IHoverInteractionOptions as aT, IElementOptions as aU, ICoreChartOptions as aV, EasingFunction as aW, IFontSpec as aX, TextAlign as aY, BasePlatform as aZ, BasicPlatform as a_, Registry as aa, registry as ab, ITick as ac, IScaleOptions as ad, Scale as ae, IScriptAbleScaleContext as af, ScriptAbleScale as ag, Ticks as ah, TypedRegistry as ai, IVisualElement as aj, ICommonOptions as ak, ICommonHoverOptions as al, ISegment as am, IArcProps as an, IArcOptions as ao, IArcHoverOptions as ap, Arc as aq, ILineProps as ar, ILineOptions as as, ILineHoverOptions as at, Line as au, IPointProps as av, PointStyle as aw, IPointOptions as ax, IPointHoverOptions as ay, IPointPrefixedOptions as az, IBarControllerChartOptions as b, ConfigurationData as b$, Filler as b0, IFillerOptions as b1, FillTarget as b2, IFillTarget as b3, IFillerControllerDatasetOptions as b4, Legend as b5, ILegendItem as b6, LegendElement as b7, ILegendOptions as b8, ILegendChartOptions as b9, ICategoryScaleType as bA, IRadialLinearScaleType as bB, ITimeScaleType as bC, ITimeSeriesScaleType as bD, IScaleChartOptions as bE, DeepPartial as bF, IChartDataset as bG, IBarControllerDataset as bH, ILineControllerDataset as bI, IScatterControllerDataset as bJ, IBubbleControllerDataset as bK, IPieControllerDataset as bL, IDoughnutControllerDataset as bM, IPolarAreaControllerDataset as bN, IRadarControllerDataset as bO, IChartData as bP, IChartOptions as bQ, IChartConfiguration as bR, IBarControllerConfiguration as bS, ILineControllerConfiguration as bT, IScatterControllerConfiguration as bU, IBubbleControllerConfiguration as bV, IPieControllerConfiguration as bW, IDoughnutControllerConfiguration as bX, IPolarAreaControllerConfiguration as bY, IRadarControllerConfiguration as bZ, ConfigurationOptions as b_, Title as ba, ITitleOptions as bb, ITitleChartOptions as bc, TooltipModel as bd, Tooltip as be, ITooltipCallbacks as bf, ITooltipPlugin as bg, ITooltipOptions as bh, ITooltipChartOptions as bi, ITooltipItem as bj, IGridLineOptions as bk, ITickOptions as bl, ICartesianScaleOptions as bm, ICategoryScaleOptions as bn, CategoryScale as bo, ILinearScaleOptions as bp, LinearScale as bq, ILogarithmicScaleOptions as br, LogarithmicScale as bs, ITimeScaleOptions as bt, TimeScale as bu, TimeSeriesScale as bv, IRadialLinearScaleOptions as bw, RadialLinearScale as bx, ILinearScaleType as by, ILogarithmicScaleType as bz, IBubbleControllerDatasetOptions as c, ConfigurationDataset as c0, IBubbleDataPoint as d, BubbleController as e, ILineControllerDatasetOptions as f, ILineControllerChartOptions as g, IScatterControllerDatasetOptions as h, IScatterDataPoint as i, IScatterControllerChartOptions as j, IDoughnutControllerDatasetOptions as k, IDoughnutAnimationOptions as l, IDoughnutControllerChartOptions as m, IDoughnutDataPoint as n, IPieControllerDatasetOptions as o, IPieControllerChartOptions as p, IPieAnimationOptions as q, IPieDataPoint as r, IPolarAreaControllerDatasetOptions as s, IPolarAreaAnimationOptions as t, IPolarAreaControllerChartOptions as u, PolarAreaController as v, IRadarControllerDatasetOptions as w, IRadarControllerChartOptions as x, IDateAdapter as y, DateAdapter as z };
